...
I'm a **DevOps / Cloud Engineer** focused on building reliable, secure, and scalable infrastructure. I work across **AWS, Azure, and GCP**, with a strong emphasis on **containerization, infrastructure as code, and CI/CD automation**. I'm also growing my expertise in **DevSecOps** and **Site Reliability Engineering (SRE)**, bringing security and reliability into every stage of the delivery pipeline.
...
<!--
**Pol-Vaibhav-Sanjay/Pol-Vaibhav-Sanjay** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
